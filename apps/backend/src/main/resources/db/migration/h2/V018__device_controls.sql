...
CREATE INDEX idx_capture_sessions_scan_line ON capture_sessions(scan_line_position);
CREATE INDEX idx_capture_sessions_capture_rate ON capture_sessions(capture_rate);
