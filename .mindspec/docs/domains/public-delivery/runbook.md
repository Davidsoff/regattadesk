...
- Regenerate frontend API bindings with `npm run api:generate` if public contract changes originate in `.mindspec/docs/specs/pdd-v0.1/design/openapi-v0.1.yaml`.
