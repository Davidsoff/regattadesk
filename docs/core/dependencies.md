...
**Note:** This inventory is maintained automatically where possible and manually reviewed regularly. See `docs/core/dependency-governance.md` for the complete governance policy.
