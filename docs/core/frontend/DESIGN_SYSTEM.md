...
This directory contains the design system implementation for RegattaDesk v0.1, including design tokens, primitive components, and accessibility utilities aligned with `docs/specs/pdd-v0.1/design/style-guide.md`.
...
- `docs/specs/pdd-v0.1/design/style-guide.md` - Complete style guide specification
- `docs/specs/pdd-v0.1/implementation/bc05-public-experience-and-delivery.md` - BC05 feature list
