...
All payment endpoints, methods, parameters, and schemas are defined in `docs/specs/pdd-v0.1/design/openapi-v0.1.yaml`.
...
- Staff API: Traefik-forwarded identity (Authelia SSO), regatta-scoped roles (+ super_admin).
  - Contract details (security schemes, headers, and endpoint-level auth) are defined in `docs/specs/pdd-v0.1/design/openapi-v0.1.yaml`.
...
- Public:
  - Endpoint contracts are defined in `docs/specs/pdd-v0.1/design/openapi-v0.1.yaml`.
...
OpenAPI contract source of truth: `docs/specs/pdd-v0.1/design/openapi-v0.1.yaml`.
